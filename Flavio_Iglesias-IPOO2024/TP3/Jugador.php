...
class Jugador extends Persona {
    ...
    public function __construct(string $nombre_completo,string $fecha_nacimiento,int $dni, int $cant_puntos,Equipo $equipo) {
    ...
    public function setCantidadPuntos (int $cant_puntos) :void {
        $this->cant_puntos=$cant_puntos;
    }
